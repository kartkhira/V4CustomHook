...
interface AggregatorInterface {
  ...
  function getAnswer(bytes32 key, uint256 roundId) external view returns (int256);

  function getTimestamp(bytes32 key, uint256 roundId) external view returns (uint256);
